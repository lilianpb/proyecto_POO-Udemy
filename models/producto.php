...
class Producto
{
    ...
    public function getAllCategory()
    {
        ...
        $sql = "SELECT p.*, c.nombre as 'catnombre' FROM  productos p JOIN categorias c ON (c.id = p.categoria_id)  WHERE p.categoria_id = {$this->getCategoria_id()} ORDER BY id DESC";
